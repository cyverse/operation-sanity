...
Feature: Delete, then launch all featured images
  ...
  Scenario Outline: Delete launched instances
    ...
    Examples: Selected images
      ...
      | Ubuntu 16.04 GUI XFCE Base     | CyVerse Cloud - Marana         | tiny1 (CPU: 1, Mem: 4 GB, Disk: 30 GB)    |
      | Ubuntu 14.04.2 XFCE Base       | CyVerse Cloud - Marana         | tiny1 (CPU: 1, Mem: 4 GB, Disk: 30 GB)    |
      | CyVerse CentOS 6.8 GUI Base    | CyVerse Cloud - Marana         | tiny1 (CPU: 1, Mem: 4 GB, Disk: 30 GB)    |
  ...
  Scenario Outline: Launch all featured images
    ...
    Then I should see an element with the css selector ".launch-button" within 20 seconds
    ...
    Examples: Selected images
      ...
      | bc624522-d224-42ba-835a-ab7389f250a5 | Ubuntu 16.04 GUI XFCE Base     | CyVerse Cloud - Marana         | tiny1 (CPU: 1, Mem: 4 GB, Disk: 30 GB)    |
      | d559c236-53ef-437a-999e-02ae16c4b5f0 | Ubuntu 14.04.2 XFCE Base       | CyVerse Cloud - Marana         | tiny1 (CPU: 1, Mem: 4 GB, Disk: 30 GB)    |
      | 524bd34b-5579-4f7e-958b-172ff6c403db | CyVerse CentOS 6.8 GUI Base    | CyVerse Cloud - Marana         | tiny1 (CPU: 1, Mem: 4 GB, Disk: 30 GB)    |
