...
Feature: Delete all featured images
    ...
    Scenario Outline: Delete instances and projects
        ...
        And I double-check that I press "Delete Project"
    ...
    Examples: Featured images
        ...
        | Ubuntu 14.04.2 XFCE Base       | BDD-1        | 50     | iPlant Workshop Cloud - Tucson​ |
        ...
        | iPlant Centos 6.5 NoGUI Base3  | BDD-5        | 300    | iPlant Workshop Cloud - Tucson​ |

        | Ubuntu 14.04.2 XFCE Base       | BDD-6        | 300    | iPlant Cloud - Tucson​          |
        | Ubuntu 14.04 with Docker 1.7.x | BDD-7        | 400    | iPlant Cloud - Tucson​          |
        | Ubuntu 14.04.3 NoGUI Base      | BDD-8        | 400    | iPlant Cloud - Tucson​          |
        | functional genomics_v1.0       | BDD-9        | 400    | iPlant Cloud - Tucson​          |
        | iPlant Centos 6.5 NoGUI Base3  | BDD-10       | 50     | iPlant Cloud - Tucson​          |

        | Ubuntu 14.04.2 XFCE Base       | BDD-11       | 50     | iPlant Cloud - Austin          |
        | Ubuntu 14.04 with Docker 1.7.x | BDD-12       | 100    | iPlant Cloud - Austin          |
        | Ubuntu 14.04.3 NoGUI Base      | BDD-13       | 100    | iPlant Cloud - Austin          |
        | functional genomics_v1.0       | BDD-14       | 100    | iPlant Cloud - Austin          |
        | iPlant Centos 6.5 NoGUI Base3  | BDD-15       | 200    | iPlant Cloud - Austin          |